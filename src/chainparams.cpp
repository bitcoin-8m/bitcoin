...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BITCOIN8M].nTimeout = 1646539164; //  March 6, 2022
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BITCOIN8M].bit = 8;
        consensus.vDeployments[Consensus::DEPLOYMENT_BITCOIN8M].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
